...
internal object BackendOpenApiContract {
    const val SHA256 = "4ae7ae9916bbfba27f588c38e7d3c9fefcd6b7eb8ca874c648b0bd112d218c36"
    ...
    val schemaFields = mapOf(
        ...
        "ChatMessageResponse" to setOf("agentTraceId", "content", "correlationId", "createdAt", "id", "responseStatus", "role", "sessionId", "sources", "suggestedDestinations", "suggestedQuestions"),
        ...
        "CookingPlanExecutionResponse" to setOf("finishedAt", "planId", "savedAt", "steps", "version"),
        "CookingPlanExecutionStep" to setOf("status", "stepId", "updatedAt"),
        "CookingPlanExecutionUpdateRequest" to setOf("expectedVersion", "status", "stepId"),
        ...
        "CookingPlanSummary" to setOf("completedAt", "completedStepCount", "createdAt", "dishNames", "finishedAt", "makespanMinutes", "planId", "savedAt", "sourceCount", "status", "taskCount"),
        ...
        "DrinkRecordResponse" to setOf("canManage", "comment", "createdAt", "drinkName", "groupId", "iceLevel", "id", "imageUrl", "mediaAssetId", "occurredAt", "placeId", "price", "rating", "shopNameSnapshot", "sweetnessLevel", "updatedAt", "version", "visibility", "wouldBuyAgain"),
        ...
        "FoodRecordResponse" to setOf("canManage", "comment", "createdAt", "cuisineCode", "cuisineId", "cuisineName", "groupId", "id", "imageUrl", "mealId", "mealNameSnapshot", "mediaAssetId", "occurredAt", "placeId", "placeNameSnapshot", "price", "rating", "updatedAt", "version", "visibility", "wouldEatAgain"),
        ...
        "PostChatMessageRequest" to setOf("content", "referenceIds", "useSessionReferences"),
